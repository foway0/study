...
const (
	TodoService_CreateTodo_FullMethodName  = "/api.TodoService/CreateTodo"
	TodoService_ListTodos_FullMethodName   = "/api.TodoService/ListTodos"
	TodoService_GetTodoById_FullMethodName = "/api.TodoService/GetTodoById"
	TodoService_UpdateTodo_FullMethodName  = "/api.TodoService/UpdateTodo"
	TodoService_DeleteTodo_FullMethodName  = "/api.TodoService/DeleteTodo"
)
