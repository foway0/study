...
const (
	Ping_Ping_FullMethodName = "/api.Ping/Ping"
)
...
func (c *pingClient) Ping(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*PingReply, error) {
...
func (UnimplementedPingServer) Ping(context.Context, *emptypb.Empty) (*PingReply, error) {
