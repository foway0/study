...
const file_ping_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"ping.proto\x12\x03api\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	"\tPingReply\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage26\n" +
	"\x04Ping\x12.\n" +
	"\x04Ping\x12\x16.google.protobuf.Empty\x1a\x0e.api.PingReplyB\bZ\x06./;apib\x06proto3"
...
var file_ping_proto_depIdxs = []int32{
	1, // 0: api.Ping.Ping:input_type -> google.protobuf.Empty
	0, // 1: api.Ping.Ping:output_type -> api.PingReply
